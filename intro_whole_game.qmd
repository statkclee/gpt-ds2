...
다양한 데이터에 대한 이해와 분석 경험이 쌓이면서 `tidyverse`가 새롭게 출현했고, 관련하여 데이터 문법(grammar of data), 그래프 문법(grammar of graphics), 표 문법(grammar of table)이 `tidyverse`의 중추를 이룬다. 각각을 자세히 살펴보기에 앞서 데이터 과학 맛보기를 통해 전반적인 흐름을 살펴보자.
...
![스쿠타리 병원의 한 병동 석판화 그림 (William Simpson)](images/scutari.jpg){#fig-nightingale-scutari fig-align="center"}
...
[^tool-viz-1]: 출처: [How Florence Nightingale Changed Data Visualization Forever - The celebrated nurse improved public health through her groundbreaking use of graphic storytelling](https://www.scientificamerican.com/article/how-florence-nightingale-changed-data-visualization-forever/)

::: {#fig-nightingale layout-ncol="5"}
![막대그래프](images/nightingale_graph_01.jpg){#fig-barchart fig-align="center" width="193"}

![맨체스터 사망](images/nightingale_graph_02.jpg){#fig-circular fig-align="center" width="249"}

![빅토리아 여왕 보고(I)](images/nightingale_graph_03.jpg){fig-align="center" width="248"}

![빅토리아 여왕 보고(II)](images/nightingale_graph_04.jpg){fig-align="center" width="247"}

![빅토리아 여왕 보고(III)](images/nightingale_graph_05.jpg){fig-align="center" width="249"}
