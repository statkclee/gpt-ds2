...
관련하여 데이터 문법(grammar of data), 그래프 문법(grammar of graphics), 표문법(grammar of table)이 `tidyverse`의 중추를 이루는데 각각을 자세히 살펴보기에 앞서 데이터 과학 맛보기를 통해 전반적인 흐름을 살펴보자.
...
나이팅게일 활약 전과 후로 데이터(`death_viz`)를 나눠 "크림전쟁 병사 사망원인"에 대한 극좌표계 시각화를 통해 이해하기쉬운 설득력 있는 시각화 결과물을 제시하고 있다.
...
동일한 정보를 막대그래프를 통해 시각화를 할 수도 있다.
